...
from bot.helper.ext_utils.help_messages import get_help_string
...
async def bot_help(_, message):
    ...
    is_sudo = user_id in sudo_users or user_id == Config.OWNER_ID
    
    await send_message(message, get_help_string(user_id=user_id, is_sudo=is_sudo))
