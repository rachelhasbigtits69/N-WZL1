...
<b>Validity:</b> {validity}"""
 ...
 • <b>U :</b> {disk_u} | <b>F :</b> {disk_f} | <b>T :</b> {disk_t}
    ...
    SYS_STATS = """<blockquote><b><i>OS SYSTEM :</i></b></blockquote>
...
<blockquote><b><i>NETWORK STATS :</i></b></blockquote>
 ...
 • <b>Usable CPU(s) :</b> {cpu_use}
    ...
    REPO_STATS = """<blockquote><b><i>REPO STATISTICS :</i></b></blockquote>
...
✦ <b>REMARKS :</b> <code>{remarks}</code>
    ...
    BOT_LIMITS = """<blockquote><b><i>BOT LIMITATIONS :</i></b></blockquote>
 ...
 • <b>RClone Limit :</b> {RL} GB
 • <b>JDown Limit :</b> {JL} GB
 • <b>Archive Limit :</b> {AL} GB
 • <b>Extract Limit :</b> {EL} GB
 • <b>Threshold Storage :</b> {TS} GB
    """

    RESTARTING = "<i>Restarting...</i>"
    RESTART_SUCCESS = """<blockquote><b><i>Restarted Successfully!</i></b></blockquote>
 • <b>Date:</b> {date}
 • <b>Time:</b> {time}
 • <b>TimeZone:</b> {timz}
 • <b>Version:</b> {version}"""
...
<blockquote><b><i>Bot Stats</i></b></blockquote>
 ...
 • <b> Leech Caption Style :</b> <i>{LCAPTIONSTYLE}</i>
