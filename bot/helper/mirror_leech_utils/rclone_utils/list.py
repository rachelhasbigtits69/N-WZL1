...
from bot.helper.ext_utils.bot_utils import cmd_exec, update_user_ldata, new_task
...
class RcloneList:
    ...
    async def get_path_buttons(self):
        ...
        if items_no > LIST_LIMIT:
            ...
            buttons.data_button(BotTheme("PREVIOUS"), "rcq pre", position="footer")
            buttons.data_button(BotTheme("NEXT"), "rcq nex", position="footer")
