...
class RcloneTransferHelper:
    ...
    async def upload(self, path):
        ...
        if Config.STRICT_FILE_MODE and await aiopath.isfile(path):
            ...
            if not is_allowed:
                ...
                return
        elif Config.STRICT_FILE_MODE and await aiopath.isdir(path):
            LOGGER.info("STRICT_FILE_MODE: Note - Directory filtering not applied to Rclone transfers. "
                       "Rclone will upload all files in the directory.")
